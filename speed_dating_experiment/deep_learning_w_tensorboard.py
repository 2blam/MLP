...
run = run + 1
log_filepath_run = log_filepath + "/run" + str(run)
# NN settings
numOfInputNodes = 172
numOfHiddenNodes = 75 # 75
#numOfHiddenNodes = 75
numOfEpoch = 30
...
with tf.Graph().as_default():
    ...
    # call back
    tb_cb = keras.callbacks.TensorBoard(log_dir=log_filepath_run, histogram_freq=1)
    cbks = [tb_cb]
    ...
    classifier.fit(X_train, y_train, batch_size=10, nb_epoch=numOfEpoch, callbacks=cbks)
